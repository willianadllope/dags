...
sql_queries =   [
                    ...
                    Consultas(consulta='SELECT id, id_pai, descricao, seleciona, nivel, importante, lista_cnae, ordem, '' '' as ts, retencoes, divulgavel, utilizado_externamente, uso_interno FROM systax_regras.dbo.ex_origem;',  tabela='ex_origem',limite=100000),
                    Consultas(consulta='SELECT id, id_pai, descricao, seleciona, nivel, importante, lista_cnae, ordem, '' '' as ts, retencoes, correlacao_ex_origem, divulgavel, utilizado_externamente, uso_interno FROM systax_regras.dbo.ex_destinacao;',  tabela='ex_destinacao',limite=100000),
                ]
