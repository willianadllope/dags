...
export_query_to_parquet("Select id_cliente, id_config, cod_prod, origem_produto, menorts from public.tabelao", pastas['parquet']+'FULL/ajusteponteirords/', "regrasponteiros",200000)
